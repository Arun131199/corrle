    ...
    return (
        <div className="p-6 max-w-7xl mx-auto">
            ...
            <div className="flex justify-between items-center mb-8">
                <div>
                    <h1 className="text-3xl font-bold text-gray-800 mb-2">Your Cards</h1>
                    <p className="text-gray-600">Manage your payment cards and accounts</p>
                </div>
                <button
            ...
            <div className="relative mb-12">
                ...
                <div className="flex space-x-6 overflow-x-auto pb-4 scrollbar-hide">
                    {cards.map((card, index) => (
                        <div
                            key={card.id}
                            className={`flex-shrink-0 w-96 transition-all duration-500 ${index === activeCard ? 'scale-105' : 'scale-95 opacity-80'
                        ...
                        <div key={transaction.id} className="flex items-center justify-between p-3 hover:bg-gray-50 rounded-lg">
                            <div className="flex items-center space-x-3">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm text-gray-500">{transaction.merchant} • {transaction.date}</p>
                                </div>
                            </div>
